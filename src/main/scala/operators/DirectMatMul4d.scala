...
class DirectMatMul4d(
  ...
  private val matMuls = VecInit.fill(shapeOutput._1, shapeOutput._2)(Module(new DirectMatMul(w, wResult, shapeInput._3, shapeWeight._4, shapeWeight._3, signed)).io)

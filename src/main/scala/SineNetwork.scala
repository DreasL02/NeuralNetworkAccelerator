...
class SineNetwork(
  ...
  val io = IO(new Bundle {
    ...
    val outputChannel = new DecoupledIO(Vec(1, Vec(1, UInt(w.W))))
  ...
  rounder1.io.inputChannel <> bias1.io.resultChannel

  val relu1 = Module(new ReLU(w, 1, 16, enableDebuggingIO))
  relu1.io.inputChannel <> rounder1.io.resultChannel

  val mmu2 = Module(new MatMul(w, wResult, 1, 16, 16, signed, enableDebuggingIO))
  mmu2.io.inputChannel <> relu1.io.resultChannel
  ...
  rounder2.io.inputChannel <> bias2.io.resultChannel

  val relu2 = Module(new ReLU(w, 1, 16, enableDebuggingIO))
  relu2.io.inputChannel <> rounder2.io.resultChannel

  val mmu3 = Module(new MatMul(w, wResult, 1, 1, 16, signed, enableDebuggingIO))
  mmu3.io.inputChannel <> relu2.io.resultChannel
  ...
  rounder3.io.inputChannel <> bias3.io.resultChannel

  io.outputChannel <> rounder3.io.resultChannel

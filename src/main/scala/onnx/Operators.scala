...
object Operators {
  ...
  case class ConvType(w: Int, wResult: Int, inputShape: (Int, Int, Int, Int), kernelShape: (Int, Int, Int, Int), signed: Boolean, strides: (Int, Int), pads: (Int, Int)) {
    require(w > 0, "w must be greater than 0")
  ...
  case class MatMulType(wOperands: Int, wResult: Int, signed: Boolean, operandAShape: (Int, Int, Int, Int), operandBShape: (Int, Int, Int, Int)) {
    require(wOperands > 0, "wOperands must be greater than 0")
